...
public class Constants {
	...
	public static String REST_API_SHEET = "REST_APIs";
	...
	public static String FLAG_EXE = "Not Executred";
	public static String KEYWORD_WARN = "WARN";
	public static String COMPONENT = "Component>>Scenarios";
	public static String BlockedRef = "Block(Y/N)";
	public static String CONFIG_SHEET = "Config";
	public static String QUERY_SHEET = "Query";
	public static String SCREEN_SHEET = "Screens";
	public static String LOCATOR_SHEET = "Locators";
