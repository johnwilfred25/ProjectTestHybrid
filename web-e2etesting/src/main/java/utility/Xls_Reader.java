...
public class Xls_Reader {
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			for (int i = 0; i < row.getLastCellNum(); i++) {
				...
				// if(row.getCell(i).getStringCellValue().trim().equals(colName.trim())) //By
				// tejas
	...
	//
	// datatable = new
	// Xls_Reader("H:\\Student_Selenium_Workspaces\\Framework_Weekend\\src\\Framework_XL_Files\\Controller.xlsx");
